...
test("binaryExpressionReduction: + operator", () => {
...
test("binaryExpressionReduction: two + operators", () => {
  assert.deepEqual(transform("const foo = 2 + 2 + 2;\n"), "const foo = 6;\n")
})

test("binaryExpressionReduction: three + operators", () => {
  assert.deepEqual(
    transform("const foo = 2 + 2 + 2 + 2;\n"),
    "const foo = 8;\n"
  )
})

test("binaryExpressionReduction: + and - operators", () => {
  assert.deepEqual(transform("const foo = 2 + 2 - 2;\n"), "const foo = 2;\n")
})
...
test("binaryExpressionReduction: + and * operators", () => {
  ...
  assert.deepEqual(
    transform("const foo = 2 + 2 * 2 + 2 * 2;\n"),
    "const foo = 10;\n"
  )
  assert.deepEqual(
    transform("const foo = 3 + 3 * 3 + 3 * 3;\n"),
    "const foo = 21;\n"
  )
  assert.deepEqual(
    transform("const foo = 4 + 4 * 4 + 4 * 4;\n"),
    "const foo = 36;\n"
  )
