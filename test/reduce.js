...
test("reduce (object oriented): works for numbers", () => {
...
test("reduce (object oriented): works for objects", () => {
...
test("reduce (object oriented): works for arrays", () => {
  const tree = new AbstractSyntaxTree("var a = 1, b = 2;")
...
test("reduce (functional): works for numbers", () => {
